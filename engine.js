...
var _audit_bit = Module['_audit_bit'] = makeInvalidEarlyAccess('_audit_bit');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['audit_bit'] != 'undefined', 'missing Wasm export: audit_bit');
  ...
  _audit_bit = Module['_audit_bit'] = createExportWrapper('audit_bit', 2);
